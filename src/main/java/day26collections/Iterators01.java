...
public class Iterators01 {
    ...
    /*
        ...
        5)There are two types of iterators i)Iterator: It can "just remove" the elements, it is impossible to update and add.
                                           ...
                                           ii)ListIterator: It can remove and update and add the elements
                                                            It works from left to the right and right to left
     */
    ...
    public static void main(String[] args) {
        ...
        while(myItr.hasNext()){  // checks if there is an element after it starting from the pointer
            myItr.next();        // if there was an element it takes the pointer to the next element and
                                 // returns the element that was skipped with the pointer
            myItr.remove();      // removes the returned element from next(). (the element that was skipped)
        }
        System.out.println(myList);//[] ==> empty list
