...
/*
        ...
        ii) Child(Sub) Classes can use methods or variables from Parent(Super) Classes but Parent Classes
         cannot use methods or variables from Child Classes
        iii) *)For "public" and "protected" access modifiers, there is no any issue in "inheritance"
         ...
         v) Java does not accept multiple parents for a class, "Java does not support multiple
