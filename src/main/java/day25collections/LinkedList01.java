...
public class LinkedList01 {
    /*
        1)Removing operation needs too much tasks for Java,
         that is why if we need too much removing operation
          we do not prefer to use ArrayLists(because it uses indexes)
    ...
    public static void main(String[] args) {
        ...
        //Returns the element previously at the specified position(removed element)
        ...
        //Returns true if the list contained the specified element
        boolean r4= names.removeFirstOccurrence("Brad");
        ...
        boolean r5= names.removeLastOccurrence("Brad");
        ...
        */
        ...
        //NoSuchElementException – if this list is empty
        String r6 = students.element();
        System.out.println(r6);//Brad
        System.out.println(students);// [Brad, Jim, Brad, Brad, Ali]

        //Retrieves, but does not remove, the first element of this list.(Copy + Paste)
        //Returns the head of this list, or null if this list is empty
        String r7 = students.peek();
        System.out.println(r7);//Brad
        System.out.println(students);// [Brad, Jim, Brad, Brad, Ali]

        //Returns the first element in this list
        //NoSuchElementException – if this list is empty
        String r8 = students.getFirst();
        System.out.println(r8);//Brad
        System.out.println(students);// [Brad, Jim, Brad, Brad, Ali]

        String r9 = students.get(1);
