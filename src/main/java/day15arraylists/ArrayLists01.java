...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        System.out.println(names);//[Christian,Tommy,Tom] ==> removes adriana from the updated names list
        ...
        //inside remove() method parenthesis is "primitive int", it will be an index.
