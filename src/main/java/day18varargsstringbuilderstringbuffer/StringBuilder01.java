...
public class StringBuilder01 {
    // offset => when using number of characters
    // index => when using indexes
  ...
  /*
    ...
    public static void main(String[] args) {
        ...
        //If "Reverse a String" question is asked to you in an interview, do not forget to mention reverse() method
