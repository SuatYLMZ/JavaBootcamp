...
public class Variables01 {
    ...
    public static int x=12;// this is static
    public static void main(String[] args) {

        // Example1: Create 3  variables different data types and print them.
        ...
        //Example 2: Create two variables for name and surname and print  them int console?
        // your name : Mohammad
