package day21inheritance;
    ...
    /*
        ...
        6)"super()" is for calling constructor from the first level "Parent Class"(closest parent)
        ...
        10)"this()" is for calling constructor from the class itself ( both in the same class)
        11)When you type "this()", you have to type it into the first line inside the constructor.
        12)"this()" and "super()" cannot be used in the same constructor body together, because
